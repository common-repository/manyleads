...
class manyleads_Public {
	...
	public function enqueue_styles() {
		...
		//wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/manyleads-public.css', array(), $this->version, 'all' );
	...
	public function embed_code() {
		$script = get_option( 'manyleads_script' );
		if(strlen( $script )>8){
			echo $script;
		}
	}
